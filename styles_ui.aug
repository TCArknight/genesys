...
<!-- ##### Styles - Labels ##### -->
  ...
  <!-- generic 'normal' label with border - center-aligned -->
  <style
    id="lblBorder"
    border="sunken">
    <style_label
  ...
  <!-- left-aligned 'normal' label for skill display -->
  <style
    id="lblSkill">
    <style_label
      textcolorid="clrnormal"
...
<!-- ##### Styles - Separator ##### -->
  ...
  <style
    ...
    <style_separator
      isvertical="no"
      start="lnkhorzsta" center="lnkhorzmid" end="lnkhorzend">
      </style_separator>
    <resource
      id="lnkhorzsta"
      isbuiltin="no">
      <bitmap
        bitmap="lnk_horz_start.bmp">
        </bitmap>
      </resource>
    <resource
      id="lnkhorzmid"
  ...
  <style
    ...
    <style_separator
      isvertical="yes"
      start="lnkvertsta" center="lnkvertmid" end="lnkvertend">
      </style_separator>
    <resource
      id="lnkvertsta"
      isbuiltin="no">
      <bitmap
        bitmap="lnk_vert_start.bmp">
        </bitmap>
      </resource>
    <resource
      id="lnkvertmid"
